...
<input type="datetime-local" name="match_datetime"
       value="2020-01-31T14:00" min="2020-01-01T11:00" max="2021-12-31T14:00">
</div>
<div class="input-group mb-3">
  <div class="input-group-prepend">
...
<div class="input-group mb-3">
  <div class="input-group-prepend">
    ...
    <input type="number" id="score_home" name="score_home"
       min="0" max="25">
  </select>
</div>
<div class="input-group mb-3">
  <div class="input-group-prepend">
   ...
   <input type="number" id="score_visitor" name="score_visitor"
       min="0" max="25">
