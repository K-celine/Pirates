...
<div class="container mw-100" id="container_club">
	...
	<div class="row" id="palmares">
		<div class="col-12">
			<div class="card-deck m-5">
				<div class="card">
					<img src="<?php echo base_url()?>assets/images/club/pirates_club_palm1.png" class="card-img-top rounded-top" alt="pirates_club_palm1">
					<div class="card-body">
						<ul class="card-text">
				...
				<div class="card">
					<img src="<?php echo base_url()?>assets/images/club/pirates_club_palm2.png" class="card-img-top rounded-top" alt="pirates_club_palm2">
					<div class="card-body">
						<ul class="card-text">
				...
				<div class="card">
					<img src="<?php echo base_url()?>assets/images/club/pirates_club_palm3.png" class="card-img-top rounded-top" alt="pirates_club_palm3">
					<div class="card-body">
						<ul class="card-text"> 
		...
		<div class="col-xl-7 col-lg-12">
			<div id="orga" class="mx-auto">
				...
				<ul>
					...
					<li>MARCHANDET Marie-Bénédicte : Gestion vêtement/textile</li>
				</ul>
			</div>
		</div>
		<div class="col-xl-5 col-lg-12 p-0">
			...
			<div class="table-responsive">
				<table class="table table-bordered table-striped">
					<thead class=" bg-warning">
						<tr>
							<th scope="col"><i class="fas fa-baseball-ball"></i></th>
							<th scope="col">Groupe des 6U</th>
	...
	<div class="row" id="terrain">
		<div class="col-12 p-0">
			<iframe id="map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2112.2362382353126!2d3.1867514432174704!3d43.33278625812674!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x12b10edaa1ddfc77%3A0xaa7c59117f6c3485!2sBaseball%20Club%20Biterrois-Pirates!5e0!3m2!1sfr!2sfr!4v1579328567899!5m2!1sfr!2sfr" height="400" style="border:0;" allowfullscreen=""></iframe>
		</div>
	</div>		
</div>
