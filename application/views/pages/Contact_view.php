...
<div class="container mw-100" id="container_contact">
	<div class="row align-items-center p-0" id="nous_trouver">	
		<div class="col-sm">
			<h2><i class="fas fa-map-marker-alt"></i>LE TERRAIN</h2>
			<address>
		...
		<div class="col-sm">
			<h2><i class="fas fa-map-marker-alt"></i>L'ASSOCIATION</h2>
			<address>
	...
	<div class="row align-items-center" id="nous_rejoindre">
		<div class="col-4">
			...
			<h2>DOSSIER D'INSCRIPTION 2020</h2><br>
	...
	<div class="row align-items-center" id="nous_contacter">
		...
		<div class="col-5">
			<h2><i class="fas fa-mobile-alt"></i> AUTRES CONTACTS</h2><br>
			<address>
				<ul>
