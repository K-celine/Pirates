<!-- ici Admin_view-->
<div class="container mw-100 p-0" id="container_admin">
	...
	<?php endif; ?>
	<div class="row align-items-center p-5 mw-100" id="admin_actu">
	...
	<div class="row align-items-center p-5 mw-100" id="admin_profil">
		<div class="col-xl-3 col-lg-12 pl-5">
	...
	<div class="row align-items-center p-5 mw-100" id="admin_newsletter">
		<div class="col-xl-3 col-lg-12 pl-5">
		...
		<div class="col-xl-9 col-lg-12">
			...
			<?php endforeach; ?>
			<br><a id="btn_sub_newsletter" href="mailto:<?php foreach($sub_newsletter as $subscribers): ?><?php echo $subscribers->email_subscribe.', ' ?><?php endforeach; ?>?subject=La%20nouvelle%20Newsletter%20des%20Pirates%20est%20arrivée%20%21%20&body=Chers Supporters,%0D%0A%0D%0AVous trouverez%20ci-joint%20la%20nouvelle%20Newsletter%20des%20Pirates%20en%20attendant%20le%20prochain match.%0D%0A%0D%0ABien%20%C3%A0%20vous,%0D%0A%0D%0ALET'S%20GO%20PIRATES%20%21%20">ENVOYER NEWSLETTER</a>
		</div>
	</div>
	<div class="row align-items-center p-5 mw-100" id="admin_match">	
		<div class="col-xl-3 col-lg-12 pl-5">
	...
	<div class="row align-items-center p-5 mw-100" id="admin_standing">
		<div class="col-xl-3 col-lg-12 pl-5">
	...
	<div class="row align-items-center p-5 mw-100" id="admin_message">
		<div class="col-xl-3 col-lg-12 pl-5">
	...
	<div class="row align-items-center p-5 mw-100" id="admin_booking">
		<div class="col-xl-3 col-lg-12 pl-5">
