...
<div id="container_admin">
	...
	<?php if($this->session->flashdata('actu_created')):?>
		<div class="row row align-items-center p-5">
			<div class="col-12 pl-5">
				<p class="success"><?php echo $this->session->flashdata('actu_created');?></p>
			</div>
		</div>
	<?php endif; ?>
	<?php if($this->session->flashdata('actu_updated')):?>
		<div class="row row align-items-center p-5">
			<div class="col-12 pl-5">
				<p class="success"><?php echo $this->session->flashdata('actu_updated');?></p>
			</div>
		</div>
	<?php endif; ?>
	<?php if($this->session->flashdata('actu_deleted')):?>
		<div class="row row align-items-center p-5">
			<div class="col-12 pl-5">
				<p class="success"><?php echo $this->session->flashdata('actu_deleted');?></p>
			</div>
		</div>	
	<?php endif; ?>
	<?php if($this->session->flashdata('admin_created')):?>
		<div class="row row align-items-center p-5">
			<div class="col-12 pl-5">
				<p class="success"><?php echo $this->session->flashdata('admin_created');?></p>
			</div>
		</div>	
	<?php endif; ?>
	...
	<?php if($this->session->flashdata('match_created')):?>
		<div class="row row align-items-center p-5">
			<div class="col-12 pl-5">
				<p class="success"><?php echo $this->session->flashdata('match_created');?></p>
			</div>
		</div>	
	<?php endif; ?>
	<?php if($this->session->flashdata('match_deleted')):?>
		<div class="row row align-items-center p-5">
			<div class="col-12 pl-5">
				<p class="success"><?php echo $this->session->flashdata('match_deleted');?></p>
			</div>
		</div>	
	<?php endif; ?>
	<?php if($this->session->flashdata('match_edited')):?>
		<div class="row row align-items-center p-5">
			<div class="col-12 pl-5">
				<p class="success"><?php echo $this->session->flashdata('match_edited');?></p>
			</div>
		</div>	
	<?php endif; ?>
	<?php if($this->session->flashdata('message_deleted')):?>
		<div class="row row align-items-center p-5">
			<div class="col-12 pl-5">
				<p class="success"><?php echo $this->session->flashdata('message_deleted');?></p>
			</div>
		</div>	
	<?php endif; ?>
